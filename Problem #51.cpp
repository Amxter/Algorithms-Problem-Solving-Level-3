...
void UpdateDataClientInFile(  sClient & Client)
{
	cout << "\n\nEnter PinCode? ";
...
void SaveAllClinetInFile(vector <sClient>  vClient , string AccountNumber)
{
	fstream MyFile;
...
void UpdateInfoClinetInFile(string AccountNumber, sClient Client, vector <sClient> vClient)
{
	...
	if (FindClientByAccountNumber(AccountNumber, Client, vClient))
	{
		...
		char ch;
		cout << "\n\n Do you Update Client With Account Number ";
		...
		if (ch == 'y' || ch == 'Y')
		{
			...
			SaveAllClinetInFile(vClient , AccountNumber);
...
int main()
{
	...
	UpdateInfoClinetInFile(AccountNumber, Client, vClient);
